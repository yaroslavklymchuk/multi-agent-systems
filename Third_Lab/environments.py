...
class MazeEnv(gym.Env):
    ...
    def get_all_possible_actions(self, state):
        ...
        #     possible_actions.extend([direction for direction in self.maze_view.maze.STEPS.keys()
        #                              if self.maze_view.maze.is_open(portal_coordinates, direction)
        #                              ])
        ...
        #             (portal_coordinates + np.array(self.maze_view.maze.STEPS[direction]))[0],
        #             (portal_coordinates + np.array(self.maze_view.maze.STEPS[direction]))[1])
        #                         ]
